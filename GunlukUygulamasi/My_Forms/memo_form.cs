    ...
    public partial class memo_form : Form
    {
        ...
        private void new_button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //---------------------------
                Int32 i;
                i = GunlukUygulamasi.Properties.Settings.Default.last_memo_id + 1;
        ...
        private void save_button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //---------------------------------------
                Int32 last_id;
                last_id = GunlukUygulamasi.Properties.Settings.Default.last_memo_id;
                last_id = last_id + 1;

                //---------------------------------------

                GunlukUygulamasi.Properties.Settings.Default.last_memo_id = last_id;
        ...
        {
            GunlukUygulamasi.Properties.Settings.Default.last_memo_id = 0;
            GunlukUygulamasi.Properties.Settings.Default.Save();
        }
